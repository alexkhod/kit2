...
const BlockNoteForm = ({ values, handleSubmit, note, t }) => {
  return (
...
const BlockNoteFormWithFormik = withFormik({
...
export default translate('zver')(BlockNoteFormWithFormik(BlockNoteForm));
